...
/***/ function(module, exports, __webpack_require__) {
	...
	var Display = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(Display, { jsonApiUrl: 'http://localhost:9000'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Display = React.createClass({
	  ...
	  takeUserText: function takeUserText(e) {
	  ...
	  submitForm: function submitForm(e) {
	    ...
	    var url = this.props.jsonApiUrl;
	    var request = new XMLHttpRequest();
	    var params = { "userText": '' + this.state.userText };
